...
st.set_page_config(page_title="NextStep.AI", page_icon="🧠")

# Load the trained model
pickleFile = open("model-weights.pkl", "rb")
...
<div style="
    ...
    font-size: 2.5em;
    background: linear-gradient(135deg, #65e8be, #2b36b5);
    box-shadow: 0px 2px 10px rgba(72, 61, 139, 0.6);
    border-radius: 10px;
...
@keyframes glow {
    ...
    50% {
        # box-shadow: 0px 2px 20px rgba(138, 43, 226, 0.8);
...
"""
    ...
    with col1:
        st.image("./Images/Career_Isometric.png")

    with col2:
        st.image("./Images/career.png")

    with col3:
        st.image("./Images/Career_Outline.png")
